...
{
    protected $admin_email = "admin@shomogro.com";
    protected $admin_mobile_number = "+8801747806876";
    protected $admin_password = "666666";
    ...
    public function run ()
    {
        ...
        $user_data = [
            ...
            "mobile_number"=> $this->admin_mobile_number,
